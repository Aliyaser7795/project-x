...
namespace Spice.Areas.Admin.Controllers
{
    ...
    {
        private readonly ApplicationDbContext db;// ربط بقواعد البيانات 
        ...
        {
            var subCategories = await db.SubCategories.Include(m => m.Category).ToListAsync();//جلب الكاتوري مع السب كاتوكري 
        ...
        {
            SubCategoryAndCategoryViewModel model = new SubCategoryAndCategoryViewModel()// نستدعي فيو موديل 
            {
                CategoriesList = await db.Categories.ToListAsync(),// نجلب قائمة الكاتوكري من جدول الكاتوكري 
                SubCategory = new Models.SubCategory(),//جلب لسب كاتوكري من الموديل سب  كاتوكري 
              //التكررار لعدم
            };
            return View(model);
        }
